...
# ADD CPP /nologo /MT /W3 /GR /GX /O2 /I "../../include" /I "$(MAYA_LOCATION)/include" /I "$(PIXIEHOME)/include" /D "PIXIE" /D "MSVC6" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "_BOOL" /D ulong="unsigned long" /D uint="unsigned int" /D "_WIN32" /D "REQUIRE_IOSTREAM" /YX /FD /Zm800 /c
...
# ADD CPP /nologo /MT /W3 /GR /GX /O2 /I "../../include" /I "$(MAYA_LOCATION)/include" /I "$(AQSIS)/include" /D "AQSIS_STATIC_LINK" /D "AQSIS" /D "MSVC6" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "_BOOL" /D ulong="unsigned long" /D uint="unsigned int" /D "_WIN32" /D "REQUIRE_IOSTREAM" /YX /FD /Zm800 /c

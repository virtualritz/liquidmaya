...
** 
** Linux implementation of LiquidProcessLauncher::execute()
** ______________________________________________________________________
*/ 
#if defined(LINUX)
...
/* ______________________________________________________________________
** 
** Irix implementation of LiquidProcessLauncher::execute()
** ______________________________________________________________________
*/ 
#if defined(IRIX)
bool LiquidProcessLauncher::execute(const MString &command, const MString &arguments)
...
/* ______________________________________________________________________
** 
** Win32 implementation of LiquidProcessLauncher::execute()
** ______________________________________________________________________
*/ 
#if defined(_WIN32)

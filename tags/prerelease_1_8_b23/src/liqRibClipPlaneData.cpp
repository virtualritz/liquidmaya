...
{
  if ( debugMode ) { printf("-> creating clipPlane\n"); }
 ...
 * Class destructor
 */
liqRibClipPlaneData::~liqRibClipPlaneData()
{
  if ( debugMode ) { printf("-> killing clipPlane\n"); }
}
...
{
  if ( debugMode ) { printf("-> writing clipPlane"); }
...
{
  if ( debugMode ) { printf("-> comparing clipPlane\n"); }
...
{
  if ( debugMode ) { printf("-> returning clipPlane type\n"); }
  return MRT_Coord;
}

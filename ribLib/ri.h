...
EXTERN(RtToken)	RI_LANCZOSFILTER;
...
EXTERN(RtToken)		RI_NEWTRANSMISSION;
EXTERN(RtToken)		RI_CAUSTICS;
EXTERN(RtToken)		RI_SPECULAR;
EXTERN(RtToken)		RI_DIFFUSE;
EXTERN(RtToken)		RI_SUBSURFACE;

// 3Delight Subsurface attributes
EXTERN(RtToken)		RI_SS_SCATTERING;
EXTERN(RtToken)		RI_SS_ABSORPTION;
EXTERN(RtToken)		RI_SS_IOR;
EXTERN(RtToken)		RI_SS_SHADINGRATE;
EXTERN(RtToken)		RI_SS_SCALE;
EXTERN(RtToken)		RI_SS_MEANFREEPATH;
...
EXTERN(RtToken)		RI_SPECULARTHRESHOLD; 
EXTERN(RtToken)		RI_CONTINUATIONBYDEFAULT;

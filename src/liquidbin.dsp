...
# ADD CPP /nologo /MT /W3 /GR /GX /O2 /I "$(MAYA_LOCATION)/include" /I "$(RMANTREE)/include" /I "../include" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D ulong="unsigned long" /D uint="unsigned int" /D "PRMAN" /D "_BOOL" /YX /FD /c
...
# ADD CPP /nologo /MT /W3 /Gm /GR /GX /ZI /Od /I "$(MAYA_LOCATION)/include" /I "$(RMANTREE)/include" /I "../include" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D ulong="unsigned long" /D uint="unsigned int" /D "PRMAN" /D "_BOOL" /YX /FD /GZ /c

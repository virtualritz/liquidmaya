...
%.iss: force
	...
	@echo AppVerName=Liquid ${VER} for Maya 8 >> ../W32Installer/liquidversion.iss
	@echo OutputBaseFilename=Liquid-${LIQUIDSHORTVERSION}-${LIQRMAN}-Maya-8-Setup >> ../W32Installer/liquidversion.iss
	...
	@echo "Source: ..\\bin\\win32\\release\\${LIQRMAN}\\liquid.mll; DestDir: {app}\\bin\\maya8\\${LIQRMAN};" >> ../W32Installer/liquidversion.iss
	@echo "Source: ..\\bin\\win32\\release\\${LIQRMAN}\\liquid.exe; DestDir: {app}\\bin\\maya8\\${LIQRMAN};" >> ../W32Installer/liquidversion.iss

...
MAYA_VERSION=7
LIQUIDSETUP = $(SETUPPATH)/Output/Liquid-$(LIQUIDSHORTVERSION)-$(LIQRMAN)-Maya-$(MAYA_VERSION)-Usersetup.exe
...
%.iss:
	...
	@echo OutputBaseFilename=Liquid-${LIQUIDSHORTVERSION}-${LIQRMAN}-Maya-${MAYA_VERSION}-Usersetup >> ../W32Installer/liquidversion.iss
...
$(LIQUIDSETUP): $(SETUPINCLUDES) ../W32Installer/LiquidW32Setup.iss
	@echo $@
	@ISCC ..\\W32Installer\\LiquidW32SetupUser.iss /O..\\W32Installer\\Output /Q
